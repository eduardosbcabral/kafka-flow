        ...
        IServiceScopeFactory serviceScopeFactory)
    {
        ...
        var fallbackPolicy = Policy
            ...
            .FallbackAsync(async (context, cancellationToken) =>
            {
                ...
                var messageProducer = scope.ServiceProvider.GetRequiredService<IMessageProducer<TKey, TValue>>();
            ...
            }, (exception, context) =>
            {
                ...
                logger.LogWarning("{Message}. Attempt: {attempt}", exception.Message, attempt);
                return Task.CompletedTask;
            });

        var policy = fallbackPolicy.WrapAsync(circuitBreakerPolicy).WrapAsync(retryPolicy);
